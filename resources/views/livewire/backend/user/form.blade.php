                ...
                <div class="flex grid grid-cols-1 md:grid-cols-2 md:gaps-2">
                    <div>
                        <x-input.group className="w-full" label="Name" for="name" :error="$errors->first('name')">
                            <x-input.text wire:model="name" id="name" placeholder="Enter name" className="max-w-md"/>
                        </x-input.group>
                    </div>
                    <div>
                        <x-input.group className="w-full" label="Username" for="username" :error="$errors->first('username')">
                            <x-input.text wire:model="username" id="username" placeholder="Enter username" className="max-w-md"/>
                        </x-input.group>
                    </div>
                    <div>
                        <x-input.group className="w-full" label="Email" for="email" :error="$errors->first('email')">
                            <x-input.text wire:model="email" id="email" placeholder="Enter email" className="max-w-md"/>
                        </x-input.group>
                    </div>
                    <div>
